...
// PinAnalyser.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CPinAnalyserApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CPinAnalyserApp

CPinAnalyserApp::CPinAnalyserApp()
{
...
// Единственный объект CPinAnalyserApp

CPinAnalyserApp theApp;


// Инициализация CPinAnalyserApp

BOOL CPinAnalyserApp::InitInstance()
{
